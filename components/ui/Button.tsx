...
const variants: Record<Variant, string> = {
  // Primary CTA — bright-green gradient fill, dark on-accent text, brand glow.
  primary:
    "bg-grad-accent text-on-accent shadow-glow hover:shadow-glow-strong hover:brightness-110",
