 ...
 * 16:9 placeholder (green/black, play motif, "Coming soon") linking to its
 * /demo/<slug> page where the recorded walkthrough will embed. Replaces the old
 * interactive demo teaser / "see workflows in action" grid. Motion is carried by
 * <Reveal> (reduced-motion-safe) plus a subtle hover lift that is disabled under
