...
export const approach = {
  ...
  steps: [
    ...
    {
      icon: "users" as const,
      title: "Training + monthly AI operations",
      body: "We train your team so the change sticks — then stay on as your monthly AI operations partner: new-tool and new-model guidance, fresh training, roadmap work, and improvements as AI changes.",
    },
  ],
};
