...
import { servicesPreview } from "@/lib/fablePages";

/* /preview/fable-services — Phase 2 design preview of the Services page.
   Production /services is untouched; this route exists for review only. */
...
export default function FableServicesPreview() {
  const { hero, flagship, modules, fit, cta } = servicesPreview;
